    ...
    <main className="min-h-screen pb-24">
      ...
      <div className="site-container pt-6 md:pt-14">
        ...
        <p className="mb-12 max-w-lg prose-site text-muted">
          Selected writings live here as a doorway into longer pieces on
          Substack.
        </p>

        <ul className="space-y-14 max-w-2xl">
          {texts.length === 0 && (
            ...
            <li key={t.id} className="space-y-4">
              ...
              {t.embed_html ? (
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: t.embed_html }}
                />
              ) : null}
              <a
                href={t.substack_url}
                target="_blank"
                rel="noreferrer"
                className="inline-block font-mono-ui text-xs uppercase tracking-wide text-muted hover:text-ink underline underline-offset-4"
              >
